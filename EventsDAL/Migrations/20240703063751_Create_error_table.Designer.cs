...
namespace EventsDAL.Migrations
{
    ...
    [Migration("20240703063751_Create_error_table")]
    partial class Create_error_table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EventsDAL.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EventId = new Guid("35fda309-2469-4e1f-aaf7-bc04f17b8339"),
                            EventDate = new DateTime(2024, 7, 3, 12, 7, 50, 997, DateTimeKind.Local).AddTicks(5256),
                            EventDescription = "This is an annual event held by microsoft",
                            EventName = "Ignite"
                        },
                        new
                        {
                            EventId = new Guid("b38498b5-b7a9-4887-a222-abf375bc3ce1"),
                            EventDate = new DateTime(2024, 7, 3, 12, 7, 50, 997, DateTimeKind.Local).AddTicks(5269),
                            EventDescription = "This is an annual event held by microsoft",
            ...
            modelBuilder.Entity("EventsDAL.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationId = new Guid("117c12d9-2546-4af9-b87d-b46abe6c9ea9"),
                            LocationName = "Chennai"
                        },
                        new
                        {
                            LocationId = new Guid("3395d48b-1006-473c-9746-30be26c7f45a"),
                            LocationName = "Mumbai"
                        },
                        new
                        {
                            LocationId = new Guid("65135482-0010-4b33-9bef-b66fa0238f06"),
                            LocationName = "Seatle"
                        },
                        new
                        {
                            LocationId = new Guid("3f5b2337-3707-42fc-bb7b-34bf7e981a6f"),
